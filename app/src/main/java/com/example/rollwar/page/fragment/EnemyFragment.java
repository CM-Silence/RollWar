...
public class EnemyFragment extends Fragment implements View.OnClickListener, RvEnemyAdapter.InnerHolder.EnemyDataListener {
    ...
    private void initData(){
        ...
        enemyList.add(new EnemyDataBean(R.drawable.enemy2,"奋斗学生","充满学习动力的学生,学习还算可以,有时会钻研一些难题,战斗力一般,但数量较多。"));
        enemyList.add(new EnemyDataBean(R.drawable.enemy3,"学霸","学习较好的学生,问出的问题不是一般人能解答的,战斗力较高,有一定的威胁性。"));
        enemyList.add(new EnemyDataBean(R.drawable.enemy4,"学神","学习非常好的学生,功底十分扎实,但如果有学习上的问题基本没几个人能帮他解决,战斗力很高,需要尽快解决,否则将会产生很大的威胁。"));
    ...
    private void initView(View view){
        ...
        mBtnBack = view.findViewById(R.id.main_enemyfragment_btn_back);
        ...
        mIvEnemyImage = view.findViewById(R.id.main_enemyfragment_iv_enemy);
    }
    ...
    public void onClick(View view) {
        switch (view.getId()){
            case R.id.main_enemyfragment_btn_back:{
